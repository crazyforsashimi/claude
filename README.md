...
| 🟠 **卖出(参考)** | `PE五年分位>95 且 RSI>70`，**仅非高波动股** | 下跌58%/edge+15%；金融股极准(GS76%/MS74%/JPM78%)；高波动成长股(NVDA仅24%)已排除，非做空 |
...
### 推送的信号
**Tier2 分组**：稳健股 🟢强买入 `RSI(14)<20`/买入 `RSI(14)<25`、🟠卖出 `PE分位>95且RSI>70`；动量股三档 🟢 趋势回调组 `破下轨且价ma200上` · 大级别支撑组(SNOW/TSLA/BABA) `破100日布林` · NET/COIN 无信号。至少配一个通知渠道，未配则只在日志打印。
